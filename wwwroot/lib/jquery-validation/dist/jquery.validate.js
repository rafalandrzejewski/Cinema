...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "Proszę wprowadzić tę samą wartość ponownie.",
		...
		rangelength: $.validator.format("Proszę wprowadzić wartość o długości od {0} do {1} znaków."),
		range: $.validator.format("Proszę wprowadzić wartość z przedziału od {0} do {1}."),
